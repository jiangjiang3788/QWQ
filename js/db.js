...
const defaultIcons = {
    ...
    'tutorial-screen': {name: '使用说明与备份', url: 'https://i.postimg.cc/6QgNzCFf/chan-118.png'},
    'diary-screen': {name: '日记本', url: 'https://i.postimg.cc/bJBLzmFH/chan-70.png'},
    'storage-analysis-screen': {name: '数据分析', url: 'https://i.postimg.cc/J0F3Lt0T/chan-107.png'},
...
const globalSettingKeys = [
    'apiSettings', 'summaryApiSettings', 'backgroundApiSettings', 'supplementPersonaApiSettings', 'vectorApiSettings',
    'imageRecognitionEnabled', 'imageRecognitionApiSettings', 'stickerRecognitionApiSettings',
    'wallpaper', 'globalChatWallpaper', 'fontUrl', 'localFontName', 'fontBuffer',
    'customIcons', 'customAppNames', 'namePresets', 'apiPresets', 'summaryApiPresets', 'backgroundApiPresets',
    'supplementPersonaApiPresets', 'vectorApiPresets', 'imageRecognitionApiPresets', 'stickerRecognitionApiPresets',
    'bubbleCssPresets', 'myPersonaPresets', 'globalCss', 'globalCssPresets', 'fontPresets', 'homeSignature',
    'chatFolders', 'fontSizeScale', 'activePersonaId', 'moreProfileCardBg', 'statusBarPresets',
    'regexFilterPresets', 'themeSettings', 'themePresets', 'savedKeyboardHeight',
