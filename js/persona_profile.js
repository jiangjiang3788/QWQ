// --- 用户档案与角色绑定逻辑 (js/persona_profile.js) ---

let currentPersonaIndex = 0;
let currentEditingBindingCharId = null;

// 用户档案初始化
function setupProfilePersonaScreen() {
...
window.setupProfilePersonaScreen = setupProfilePersonaScreen;
window.setupMyProfileScreen = setupMyProfileScreen;
