...
const showToast = (notification) => {
    // 角色后台消息弹窗遵循全局开关；普通操作提示仍始终显示。
    const isRichCharacterPopup = typeof notification === 'object' && notification !== null && notification.name;
    if (isRichCharacterPopup && typeof db !== 'undefined' && db.globalToastEnabled === false) return;
