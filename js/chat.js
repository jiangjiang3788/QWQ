...
function setupChatRoom() {
    ...
    messageArea.addEventListener('click', (e) => {
        ...
        if (e.target && e.target.id === 'load-more-btn') {
            ...
            const transferCard = null; // V8.0: legacy transfer cards are display-only
            if (transferCard) {
            ...
            const familyCardAcceptBtn = null; // V8.0: legacy family-card receipts are display-only
            const familyCardReturnBtn = null;
