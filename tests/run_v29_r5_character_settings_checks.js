...
assert(/^(?:V2\.9-R(?:[5-9]|1[01])|V?2\.(?:10-R(?:[01]|2(?:\.1)?|3(?:\.[123])?|4|5|6)|11-R(?:[0124567]|3(?:\.1)?)|12-R(?:[0-4]|5(?:\.[1234])?)|13-R(?:[014]|5(?:\.[1234])?)|14-R(?:0|1|2|3|4|5|6)))$/.test(version), 'release version mismatch');
