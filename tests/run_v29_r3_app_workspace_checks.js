...
assert(/VERSION = '2\.10-R1'/.test(settings), 'settings hub compatibility version mismatch');
...
assert(/^V2\.10-R1$/.test(fs.readFileSync(path.join(root, 'VERSION.txt'), 'utf8').trim()), 'release compatibility version mismatch');
