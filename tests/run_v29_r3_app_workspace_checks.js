...
assert(/^V?2\.(?:10-R(?:1|2(?:\.1)?|3(?:\.[123])?|4|5|6)|11-R(?:[0124567]|3(?:\.1)?)|12-R(?:[0-4]|5(?:\.[123])?)|13-R(?:[014]|5(?:\.[12])?))$/.test(fs.readFileSync(path.join(root, 'VERSION.txt'), 'utf8').trim()), 'release compatibility version mismatch');
