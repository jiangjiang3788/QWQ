...
(async () => {
  ...
  const compilerPos = index.indexOf('js/core/context_compiler.js?v=582');
  ...
  const chatPos = index.indexOf('js/modules/chat_ai.js?v=582');
  ...
  assert(memoryCore.includes("const VERSION = '5.8.3'"));
